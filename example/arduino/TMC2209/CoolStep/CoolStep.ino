...
const uint8_t RUN_CURRENT_PERCENT = 12;
const uint8_t LOOPS_BEFORE_TOGGLING = 3;
const TMC2209::CurrentIncrement CURRENT_INCREMENT =
    TMC2209::CURRENT_INCREMENT_8;
const TMC2209::MeasurementCount MEASUREMENT_COUNT =
    TMC2209::MEASUREMENT_COUNT_1;
...
void setup() {
    ...
    stepper_driver.setHardwareEnablePin(PIN_XEN);
